...
16):(d[2]=a&255,d[1]=(a&65280)>>8,d[0]=(a&16711680)>>16)};this.setUint24=function(d,a,b){this.setInt24(d,a,b)};this.setString=function(d,a){for(var b=new Uint8Array(this.buffer,dataview.min.js),c=a.length;c;)b[--c]=a.charCodeAt(c)}}).call(this.DataView.prototype);
